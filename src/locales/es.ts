...
export const es: Locale = {
  ...
  recorder: {
    ...
    describeRequest: "Cuéntanos sobre ti — a qué te dedicas, tus ingresos, dónde vives, cuánto necesitas, para qué es y cómo planeas pagarlo. Entre más nos cuentes, mejor podemos personalizar una oferta para ti.",
  ...
  auth: {
    ...
    loginSubtitle: "Accede a tus solicitudes de préstamo y reportes",
    registerTitle: "Crea tu cuenta",
    registerSubtitle: "Comienza a analizar solicitudes de préstamo por voz",
    ...
    registrationError: "Error al registrarse. Inténtalo de nuevo.",
    signOut: "Cerrar Sesión",
  },
  dashboard: {
    title: "Solicitudes",
    subtitle: "Tus análisis de solicitudes de préstamo enviados",
    empty: "Sin solicitudes aún",
    emptyDesc: "Envía un memo de voz para verlo aparecer aquí.",
    analyzeNew: "Analizar Nueva Solicitud",
    searchPlaceholder: "Buscar por nombre, propósito...",
    filterAll: "Todas",
    filterApproved: "Aprobadas",
    filterDeclined: "Rechazadas",
    filterMoreInfo: "Más Info",
    filterPending: "Pendientes",
    columnApplicant: "Solicitante",
    columnAmount: "Monto",
